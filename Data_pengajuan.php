              ...
              <div class="menu_section">
                <ul class="nav side-menu">
                 ...
                 <li class="active"><a href="index.php"  style="font-weight: bold; border-left: 20px solid #cabd24;"><i class="fa fa-user" ></i> Form Pendaftaran</a></li>
                  ...
                  <li class="active"><a href="index.php"  style="font-weight: bold; border-left: 20px solid #cabd24;"><i class="fa fa-user" ></i> Data Pengajuan</a></li>
                  <li>
                      <?php
                      session_start();
